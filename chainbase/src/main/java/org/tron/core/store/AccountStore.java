...
public class AccountStore extends TronStoreWithRevoking<AccountCapsule> {
  ...
  public AccountCapsule getSun() {
    return getUnchecked(assertsAddress.get("Vacuum"));
  }
  ...
  public AccountCapsule getBlackhole() {
    return getUnchecked(assertsAddress.get("Eternity"));
  }


  public byte[] getBlackholeAddress() {
    return assertsAddress.get("Eternity");
  }
  ...
  public AccountCapsule getZion() {
    return getUnchecked(assertsAddress.get("Quazar"));
  }
